  ...
  'children': [
    ...
    },
    {
      ...
      'children': [
        ...
        {'name': 'Parallel', 'value': 5176}, {'name': 'Pause', 'value': 449},
    ...
    },
    {
      ...
      'children': [
        ...
        {'name': 'DataTable', 'value': 772}, {'name': 'DataUtil', 'value': 3322}
      ]
    },
    {
      'name': 'display',
    ...
    },
    {
      ...
      'children': [
        ...
        {'name': 'RootScale', 'value': 1756}, {'name': 'Scale', 'value': 4268},
    ...
    },
    {
      'name': 'util',
      'children': [
        {'name': 'Arrays', 'value': 8258}, {'name': 'Colors', 'value': 10001},
        {'name': 'Dates', 'value': 8217}, {'name': 'Displays', 'value': 12555},
        {'name': 'Filter', 'value': 2324}, {'name': 'Geometry', 'value': 10993},
        {
          'name': 'heap',
          'children': [
        ...
        {'name': 'Sort', 'value': 6887}, {'name': 'Stats', 'value': 6557},
      ...
      'children': [
        {
          'name': 'axis',
          'children': [
            {'name': 'Axes', 'value': 1302}, {'name': 'Axis', 'value': 24593},
...
function createTreemap(data) {
  ...
  leaf.append('text')
      ...
      .attr(
          'fill-opacity', (d, i, nodes) => i === nodes.length - 1 ? 1.0 : null)
      .text(d => d);
}
